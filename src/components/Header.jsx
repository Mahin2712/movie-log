...
export default function Header({
  ...
  return (
    <header className="flex flex-col items-center border-b border-zinc-800 bg-zinc-900/95 sticky top-0 z-30 transition-all duration-200 w-full shadow-lg backdrop-blur-md"
    ...
    >
      ...
      */}
      ...
      {/* 
        BOTTOM ROW (Mobile) / INLINE (Desktop Adaptation): 
        [Search] [Toggle]
      */}
      <div className="flex w-full items-center gap-3 mt-3 md:mt-0 md:flex-1 md:justify-center md:max-w-4xl">
        {/* Search Bar */}
