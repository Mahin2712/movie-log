  ...
  return (
    <>
      ...
      >
        ...
        {/* Header / Logo Area */}
        <div className={`flex items-center ${collapsed && !mobileOpen ? "justify-center" : "justify-between"} px-6`} style={{ height: 'var(--header-height)' }}>
        ...
        {collapsed && !mobileOpen && (
          <button
            ...
            className="mx-auto mb-6 text-zinc-500 hover:text-white transition-colors p-2 rounded-full hover:bg-white/5 hidden md:block"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <nav className="flex-1 flex flex-col gap-2 px-3 mt-2 overflow-y-auto no-scrollbar">
          <div className="mb-2">
            {(!collapsed || mobileOpen) && <div className="px-4 text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-2">Menu</div>}
